...
This trade-off justifies our use of CHA in the verification phase: while it may report some false positives, it helps us avoid false negatives and ensures that client-triggerable exceptions are not missed.
