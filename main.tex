...
\begin{document}
    ...
    \begin{abstract}
      ...
      We have evaluated UnCheckGuard on 98 library-client pairs drawn from the DUETS collection and found 10
      callsites to have a call to a library method which, when upgraded to the latest version, introduces
