...
Furthermore, we demonstrated that it is possible to trigger some of these exceptions by writing test cases using client code.\todo{TBR some? all? - clients may have hardcoded value or safety checks, hence some}
