...
We found that new potentially client-relevant unchecked exceptions occured in 8 of the 69 libraries, and that clients called methods containing these exceptions at 49 client callsites.
...
We will release the UnCheckGuard tool under an open‐source license and share our dataset on Zenodo immediately upon paper acceptance.
