...
\subsection{Newly-added Exceptions in Java Libraries}

Our evaluation included 36 client applications, which depended on 68 distinct libraries. Across these, we formed 98 client-library pairs, each corresponding to a combination of a specific client and one of its used libraries. Some of the libraries were used by multiple clients.\todo{how many clients used multiple libraries in our corpus? is the previous sentence true?}
